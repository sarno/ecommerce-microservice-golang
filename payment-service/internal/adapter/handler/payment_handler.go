...
// GetDetail implements [IPaymentHandler].
func (p *paymentHandler) GetDetail(c echo.Context) error {
	...
	result, err := p.PaymentService.GetDetail(ctx, uint(paymentIDInt), user)
	if err != nil {
...
// MidtranswebHookHandler implements [IPaymentHandler].
func (p *paymentHandler) MidtranswebHookHandler(c echo.Context) error {
...
// GetAllAdmin implements [IPaymentHandler].
...
// GetAllCustomer implements [IPaymentHandler].
...
// Create implements [IPaymentHandler].
...
func NewPaymentHandler(paymentService service.IPaymentService, e *echo.Echo, cfg *config.Config) IPaymentHandler {
